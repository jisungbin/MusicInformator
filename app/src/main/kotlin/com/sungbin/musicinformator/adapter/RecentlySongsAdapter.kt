...
import com.sungbin.musicinformator.databinding.LayoutSongsBinding
...
class RecentlySongsAdapter constructor
    ...
    class ViewHolder(private val songItemBinding: LayoutSongsBinding) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int) =
        ViewHolder(
            DataBindingUtil.inflate(
                ...
                R.layout.layout_songs, viewGroup, false
            )
        )
